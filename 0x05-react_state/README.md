...
## [](https://reactjs.org/docs/state-and-lifecycle.html#using-state-correctly)Using State Correctly
...
### [](https://reactjs.org/docs/state-and-lifecycle.html#state-updates-are-merged)State Updates are Merged
